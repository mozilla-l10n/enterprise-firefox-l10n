...
enterprise-signout-prompt-title = Se déconnecter de { -brand-short-name }?
...
extension-firefox-enterprise-dark-description = Un thème du fond de la nuit avec des dégradés bleu pétrole sombre et d'autres plus subtiles et bleus plus clairs.
blocked-by-policy-title-enterprise = Accès restreint à ce site
neterror-blocked-by-policy-page-title-enterprise = Accès restreint à ce site
